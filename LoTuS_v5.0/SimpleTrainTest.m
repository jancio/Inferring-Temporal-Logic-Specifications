...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Train and test a decision tree using LoTuS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
load(strcat(dataset_path_prefix, 'solo_R2f_75w.mat'), 'data')
...
%  Best tree decided based on the test data (this should be however based
%  on another validation set)
...
[train_MCR, train_confusion_matrix] = treeEvalPerformance(tree_pruned, train_data)
[test_MCR, test_confusion_matrix] = treeEvalPerformance(tree_pruned, test_data)
